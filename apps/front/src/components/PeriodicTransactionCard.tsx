...
const PeriodicTransactionCard = ({
  ...
  return transaction.periodic ? (
    <div
      key={transaction.id}
      className="rounded-lg p-4 text-active-text-color border-text-color border flex flex-col gap-2 w-fit max-w-[calc(50%-3rem)] mobile:max-w-full"
    >
      <TransactionsTable
      ...
      <div className="flex flex-row justify-between items-center mt-2">
        ...
        <div className="flex gap-2">
          <FTButton className="!p-0 h-8 w-8 flex items-center justify-center">
            <img
              className="w-4"
          ...
          <FTButton className="!p-0 h-8 w-8 flex items-center justify-center bg-red">
            <img
              className="w-4"
